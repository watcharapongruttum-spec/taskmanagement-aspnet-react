...
export default function TaskColumn({ title, tasks, onUpdateStatus, onDelete, onEdit, statusValue }) {
  ...
  const handleDrop = (e) => {
    ...
    onUpdateStatus(taskId, statusValue);
  };

  return (
    <div style={styles.column} onDragOver={handleDragOver} onDrop={handleDrop}>
...
const styles = {
  column: { background: '#f5f5f5', borderRadius: '8px', padding: '16px', flex: 1, minWidth: '250px', minHeight: '200px' },
